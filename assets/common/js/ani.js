let ani = {
  init: function () {
    ...
    if(!$('.t1').length){
      ...
      // sqOn(트리거,시작숫자,끝숫자,넘어갈위치)
      ani.sqOn(".txt-wrap1",1,176,$('.txt-wrap2'))
      ani.sqOn(".txt-wrap2",176,351,$('.txt-wrap3'))
      ani.sqOn(".txt-wrap3",351,526,$('.start-banner'))
  ...
  sq: function (trele, start, end, next) {
    ...
    for (let i = start; i < end; i++) {
      image.push(`../../../assets/common/images/sequence/sequence_${i}.jpg`);
    }
